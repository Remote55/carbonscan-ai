...
| 5b. PointNet++ wood/leaf candidate | Experimental | PointNet++ backend exists but is not the promoted default | services/ml/pipeline/wood_leaf_separation.py; services/ml/training/pointnet2_seg.py; docs/ml/WOODLEAF_RESULTS.md | Wan held-out Wood IoU 0.418 and Mean IoU 0.613, with selection/provenance limitations; not production-promoted. |
